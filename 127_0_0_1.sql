...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2018 at 01:39 PM
...
INSERT INTO `event_count` (`id`, `count`) VALUES
(1, 1);
...
(2, 4, '2015peccs371', 'gud', 'Not Nice'),
(3, 4, '2015peccs384', 'vkvky', 'Not Nice');
...
INSERT INTO `event_register` (`id`, `rollno`) VALUES
(1, '2015peccs364');
...
('root', '[{\"db\":\"feedback_system\",\"table\":\"student\"},{\"db\":\"feedback_system\",\"table\":\"admin\"},{\"db\":\"feedback_system\",\"table\":\"event\"},{\"db\":\"feedback_system\",\"table\":\"event_count\"},{\"db\":\"feedback_system\",\"table\":\"event_feedback\"},{\"db\":\"feedback_system\",\"table\":\"event_register\"}]');
...
('root', '2017-11-25 03:55:51', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}');
